<template>
    <div class="cut">
        ...
        <nya-container v-if="data" title="信息">
            {{ this.data }}
        </nya-container>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            this.data += "\ncontainer:" + JSON.stringify(this.$refs.cropper.getContainerData());
            this.data += "\ncropbox:" + JSON.stringify(this.$refs.cropper.getCropBoxData());
            this.data += "\ncanvas:" + JSON.stringify(this.$refs.cropper.getCanvasData());
            this.data += "\nimage:" + JSON.stringify(this.$refs.cropper.getImageData());
        },
